...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/tm157/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/tm157/oh-my-zsh/master/tools/install.sh -O -)"
```
